...
function PrivacyPolicy() {
  return (
    <main className="pb-4 h-screen overflow-auto overflow-x-hidden px-10">
      <motion.div
        className="flex flex-col h-auto max-w-6xl justify-start md:items-start items-center mx-auto mt-28 tracking-wider gap-4 text-zinc-400"
        variants={fadeInVariant}
        initial="hidden"
        animate="visible"
      >
        <h1 className="text-white md:text-6xl text-3xl font-semibold tracking-wide text-left py-5">
          Datenschutzrichtlinien
        </h1>
        <p className="mt-4" align="justify">
          Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst und halten
          uns strikt an die Regeln der Datenschutzgesetze. Personenbezogene
        ...
        <p className="mb-2" align="justify">
          Nutzen Sie das Kontaktformular, werden Ihre Daten per E-Mail ans uns
          übertragen. Diese dienen lediglich der Kontaktaufnahme und werden für
          keine weiteren Zwecke als diesen verwendet.
        </p>
        <br></br>

        <h1 className="text-white md:text-4xl text-2xl font-medium mt-20 mb-10 tracking-tight text-left">
          Datenschutzerklärung nach EU-DSGVO
        </h1>

        <p className="mb-2" align="justify">
          Verantwortliche Stelle im Sinne der Datenschutzgesetze, insbesondere
          der EU-Datenschutzgrundverordnung (DSGVO), ist: Marc Benesch
        </p>
        <br></br>

        <h3 className="text-white md:text-4xl text-2xl font-medium mt-14 mb-10 tracking-tight text-left">
        ...
        <ul className="list-square text-left ml-10 leading-6 mt-2 space-y-3 mb-2">
          <li>
        ...
        <p className="mb-2 break-all" align="justify">
          Sofern Sie uns eine Einwilligung erteilt haben, können Sie diese
          jederzeit mit Wirkung für die Zukunft widerrufen. Sie können sich
          jederzeit mit einer Beschwerde an eine Aufsichtsbehörde wenden, z. B.
          an die zuständige Aufsichtsbehörde des Bundeslands Ihres Wohnsitzes
        ...
        <p className="mb-2" align="justify">
          ...
          verwendet werden, um Programme zu starten oder Viren auf einen
          Computer zu übertragen. Anhand der in Cookies enthaltenen
          Informationen können wir Ihnen die Navigation erleichtern und die
          korrekte Anzeige unserer Webseiten ermöglichen. In keinem Fall werden
          die von uns erfassten Daten an Dritte weitergegeben oder ohne Ihre
          ...
          erfahren, wie Sie diese Einstellungen ändern können. Bitte beachten
        ...
        <p className="mb-2" align="justify">
          Art und Zweck der Verarbeitung: Diese Website benutzt Google
          Analytics, einen Webanalysedienst der Google LLC, 1600 Amphitheatre
          Parkway, Mountain View, CA 94043 USA (nachfolgend: „Google“). Google
          ...
          Informationen über Ihre Benutzung dieser Webseite werden in der Regel
          ...
          von Google zusammengeführt. Die Zwecke der Datenverarbeitung liegen in
          der Auswertung der Nutzung der Website und in der Zusammenstellung von
          Reports über Aktivitäten auf der Website. Auf Grundlage der Nutzung
          der Website und des Internets sollen dann weitere verbundene
          Dienstleistungen erbracht werden. Rechtsgrundlage: Die Verarbeitung
          der Daten erfolgt auf Grundlage einer Einwilligung des Nutzers (Art. 6
          Abs. 1 lit. a DSGVO). Empfänger: Empfänger der Daten ist Google als
          Auftragsverarbeiter. Hierfür haben wir mit Google den entsprechenden
          Auftragsverarbeitungsvertrag abgeschlossen. Speicherdauer: Die
          Löschung der Daten erfolgt, sobald diese für unsere
          Aufzeichnungszwecke nicht mehr erforderlich sind. Drittlandtransfer:
          Google verarbeitet Ihre Daten in den USA und hat sich dem EU-US
          Privacy Shield unterworfen. Außerdem haben wir
          Standarddatenschutzklauseln mit Google für den Einsatz von Google
          Analytics abgeschlossen. Bereitstellung vorgeschrieben oder
          erforderlich: Die Bereitstellung Ihrer personenbezogenen Daten erfolgt
          freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den
          Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf
          der Website kommen. Widerruf der Einwilligung: Sie können die
          ...
          das Cookie in Ihrem Browser installiert bleibt. Profiling: Mit Hilfe
          des Tracking-Tools Google Analytics kann das Verhalten der Besucher
          der Webseite bewertet und die Interessen analysiert werden. Hierzu
          erstellen wir ein pseudonymes Nutzerprofil.
        </p>
        <br></br>
        ...
        <p className=" mb-2" align="justify">
          Art und Zweck der Verarbeitung: Um unsere Inhalte browserübergreifend
          korrekt und grafisch ansprechend darzustellen, verwenden wir auf
          dieser Website „Google Web Fonts“ der Google LLC (1600 Amphitheatre
          Parkway, Mountain View, CA 94043, USA; nachfolgend „Google“) zur
          Darstellung von Schriften. Die Datenschutzrichtlinie des
          Bibliothekbetreibers Google finden Sie hier:
          https://www.google.com/policies/privacy/ Rechtsgrundlage:
          Rechtsgrundlage für die Einbindung von Google Webfonts und dem damit
          verbundenen Datentransfer zu Google ist Ihre Einwilligung (Art. 6 Abs.
          1 lit. a DSGVO). Empfänger: Der Aufruf von Scriptbibliotheken oder
          ...
          diesem Fall Google Daten erhebt. Speicherdauer: Wir erheben keine
          personenbezogenen Daten, durch die Einbindung von Google Webfonts.
          Weitere Informationen zu Google Web Fonts finden Sie unter
          https://developers.google.com/fonts/faq und in der
          Datenschutzerklärung von Google:
          https://www.google.com/policies/privacy/ Drittlandtransfer: Google
          verarbeitet Ihre Daten in den USA und hat sich dem EU-US Privacy
          Shield unterworfen. Bereitstellung vorgeschrieben oder erforderlich:
          ...
          Widerruf der Einwilligung: Zur Darstellung der Inhalte wird regelmäßig
          die Programmiersprache JavaScript verwendet. Sie können der
        ...
        <p className="mb-2" align="justify">
          ...
          verantwortliche Person in unserer Organisation: Marc Benesch
        </p>
        <br></br>

        <p className="text-white mt-20">
          © {new Date().getFullYear()} Marc Benesch - pyucation. Alle Rechte
          vorbehalten.
        </p>
      </motion.div>
    </main>
